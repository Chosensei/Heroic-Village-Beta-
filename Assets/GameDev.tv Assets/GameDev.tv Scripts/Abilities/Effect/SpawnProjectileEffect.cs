...
namespace RPG.Abilities.Effects
{
    ...
    public class SpawnProjectileEffect : EffectStrategy
    {
        ...
        public override void StartEffect(AbilityData data, Action finished)
        {
            ...
            // Set initial location of our projectile to fire from our right hand
        ...
        private void SpawnProjectileForTargetPoint(AbilityData data, Vector3 spawnPosition)
        {
            ...
            // This is the object with health component we want to target
        ...
        {
            // Spawn as many projectiles for as many targets in range
